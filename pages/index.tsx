    ...
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <ul>
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="flex justify-between my-2 odd:bg-green-300 even:bg-yellow-300 only:bg-red-300"
            >
        ...
        <ul>
          {["a", "b", "c", ""].map((c, i) => (
            <li key={i} className="my-2 bg-blue-300 py-1 empty:hidden">
              {c}
            </li>
          ))}
        </ul>
      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl group">
        ...
        <div className="bg-white rounded-3xl p-6 relative -top-5">
          ...
          <div className="relative flex flex-col items-center -mt-10 -mb-15 ">
      ...
      <div className="bg-white p-10 rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 text-center text-white rounded-lg py-4 px-8">
              Add to Cart
            </button>
          </div>
        </div>
