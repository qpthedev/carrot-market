  ...
  return (
    <Layout title="Community" hasTabBar>
      <div className="py-16 px-4 space-y-8">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex flex-col items-start cursor-pointer">
            ...
            <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[2px] w-full">
              <span className="flex spacex2 items-center text-sm">
                <svg
                  className="w-4 h-4"
                  fill="none"
                  stroke="currentColor"
        ...
        <button className="fixed bottom-20 right-5 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 hover:cursor-pointer transition-colors">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
